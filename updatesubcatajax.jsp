...
if(itemName1.equals("scatname")) //control's name - textbox name
{
cname=value;//Oils
}
...
else if(itemName1.equals("scatid")) //control's name - textbox name
{
cid=value;//Oils
}
}
...
try
{
String q = "update subcategorytable set subcatname=?,subcatimage=? where subcatid=?";
