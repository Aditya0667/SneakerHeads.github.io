	...
	<!-- top Products -->
        <div class="ads-grid">
         ...
         try
         {
             ...
             if(myresult.next())
             {
                 ...
                 do
                 {
                     out.print("<div class='col-md-4' align='center'>"
                             + "<a href='showsubcat.jsp?catid="+myresult.getString("catid")+"'>"
                                     + "<img src='upload/"+myresult.getString("catimage")+"' height='200px'></a>"
                                             + "<br/><a href='showsubcat.jsp?catid="+myresult.getString("catid")+"'"
                                                     + ">"+myresult.getString("catname")+"</div>");
                 }
                 while(myresult.next());
                 out.print("</div>");
             }
             ...
             {
                 out.print("no category added yet");
